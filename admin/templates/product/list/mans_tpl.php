                        ...
                        <?php if (isset($config['product'][$type]['check_list'])) {
                            foreach ($config['product'][$type]['check_list'] as $key => $value) { ?>
                                <th class="align-middle text-center status-box">
                                    <span><?= $value ?></span>
                                    <?php if (isset($config['product'][$type]['check_all_list']) && $config['product'][$type]['check_all_list'] == true) { ?>
                                ...
                                <?php if (isset($config['product'][$type]['show_images_list']) && $config['product'][$type]['show_images_list'] == true) { ?>
                                    <td class="align-middle">
                                        <a href="<?= $linkEdit ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['name'] ?>">
                                            <?= $func->getImage(['class' => 'rounded img-preview', 'sizes' => $config['product'][$type]['thumb_list'], 'upload' => UPLOAD_PRODUCT_L, 'image' => $items[$i]['photo'], 'alt' => $items[$i]['name']]) ?>
                                        </a>
                                    </td>
                                <?php } ?>
                                <td class="align-middle">
