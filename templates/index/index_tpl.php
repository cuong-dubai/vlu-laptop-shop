...
<section id="Post">
    <div class="Post__Wrap">
        <div class="wrap-content">
            <div class="Post__nav">
                <h2>Tin công nghệ</h2>
                <a href="tin-tuc" class="view__all__post">Xem tất cả <svg xmlns="http://www.w3.org/2000/svg" width="14"
                            ...
                            <a href="<?= $news['slug'] ?>">
                                <div class="card news-card border-0">
                                    <div class="card-img-top overflow-hidden">
                                        <img src="<?= UPLOAD_PRODUCT_L . $news['photo'] ?>" width="400" height="250"
                                            onerror="this.src='assets/images/noimage.png'" class="" alt="<?= $news['name'] ?>">
                                    </div>
